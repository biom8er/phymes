use crate::{
    AvailableTableSubscribePolicies, BuildableTrait, session::{MappableTrait, RuntimeEnv, SendableRecordBatchStreamMessageMap, StateMap}, table::{
...
// impl BuildableTrait for ProcessorEcho {
//     type T=ProcessorBuilder;
