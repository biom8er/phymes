...
pub mod open_alex {
    ...
    pub use open_alex_response::{OpenAlexResponseWorks, OpenAlexResponseAuthors, OpenAlexResponseInstitution, OpenAlexResponseTopic, 
        OpenAlexResponseAward, OpenAlexResponseFunder, OpenAlexResponsePublisher, OpenAlexResponseSource, OpenAlexResponseFind, OpenAlexResponseGroupBy};
