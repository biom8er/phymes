...
impl AvailableCandleAssets {
    ...
    pub fn get_filename(&self) -> &str {
        match self {
            ...
            Self::QwenV2p5_0p5bCoder => "qwen2.5-coder-0.5b-instruct-q4_0.gguf",
            Self::QwenV2p5_1p5bCoder => "qwen2.5-coder-1.5b-instruct-q4_0.gguf",
            Self::QwenV2p5_3bCoder => "qwen2.5-coder-3b-instruct-q4_0.gguf",
            Self::QwenV2p5_7bCoder => "qwen2.5-coder-7b-instruct-q4_0.gguf",
            Self::QwenV2p5_14bCoder => "qwen2.5-coder-14b-instruct-q4_0.gguf",
            Self::QwenV2p5_72bCoder => "qwen2.5-coder-72b-instruct-q4_0.gguf",
            Self::LlamaV3p2_7bChat => todo!(),
            Self::LlamaV3p2_13bChat => todo!(),
            Self::LlamaV3p2_70bChat => todo!(),
