...
impl DataOperatorTrait for FromWorkspaceToMessages {
    fn forward(
        ...
        from_workspace_to_messages(lhs_args, device)
    }
    fn new(_config: &DataConfig) -> Result<Self> {
        Ok(FromWorkspaceToMessages {})
    }
}
...
mod tests {
    ...
    #[test]
    fn test_from_workspace_to_messages() -> Result<()> {
...
pub use todo::Todo"#,
        ...
        let result = from_workspace_to_messages(&[repo_batch], &device)?;
