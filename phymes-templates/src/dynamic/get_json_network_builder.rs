...
impl Default for GetJsonNetworkBuilderStaticWSubject {
    fn default() -> Self {
        // Initialize the task data
        let network_name = "get_json";
        ...
        let subject_lhs = SubjectPlan::get_builder()
            .with_subject(subject)
            .build().unwrap();
        let subject = AvailableInterfaceSubjects::UserJson.to_subject(None, None).unwrap();
...
pub struct GetJsonNetworkBuilderDynamicWSubject {
    pub inner: DynamicTaskNetworkBuilder,
}

impl Default for GetJsonNetworkBuilderDynamicWSubject {
    fn default() -> Self {
        // Initialize the task data
        let network_name = "get_json";
        let subject_name_lhs = "http_client_request_json_s";
        ...
        let subject = SubjectBuilder::new()
            ...
            .append_new_user_query_str(&esearch_url, "user").unwrap()
            .build().unwrap();
        let subject_lhs = SubjectPlan::get_builder()
            .with_subject(subject)
            .build().unwrap();
...
impl Default for GetJsonNetworkBuilderDynamicWOSubject {
    fn default() -> Self {
        // Initialize the task data
        let network_name = "get_json";
        let subject_name_lhs = "http_client_request_json_s";
