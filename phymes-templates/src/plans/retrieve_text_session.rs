...
mod tests {
    ...
    use phymes_schemas::{AvailableInterfaceSubjects, AvailableSubjects, AvailableSubjectsTrait, create_documents_batch, create_documents_embeddings_batch, create_query_embeddings_batch};
