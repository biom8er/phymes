            ...
            c.bench_function(
                ...
                |b| { b.iter(|| {
                    ...
                    let _messages = rt.block_on(async {
                        bench_chat_agent_session_1(Arc::clone(&session_stream_state), &config, &user_content.0).await
                    });
                    let _messages = rt.block_on(async {
